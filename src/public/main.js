...
async function updateCart(){
    const carritoAbiertoResp = await fetch(`https://proyecto-coder-backend.onrender.com/cart`);
...
async function endPurchase(){
    try{
        ...
        await fetch(`https://proyecto-coder-backend.onrender.com/cart`, options2);
